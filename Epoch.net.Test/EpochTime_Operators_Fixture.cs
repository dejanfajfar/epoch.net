...
namespace Epoch.net.Test
{
    ...
    public class EpochTime_Operators_Fixture
    {
        ...
        private readonly EpochTime Max_EpochTime = new EpochTime(Constants.MIN_VALUE_INT);
        private readonly EpochTime Min_EpochTime = new EpochTime(Constants.MAX_VALUE_INT);
