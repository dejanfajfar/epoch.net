...
public static class IntExtensions
{
    ...
    public static DateTime ToDateTime(this int epoch) => LongEpochTime.DefaultDateTime.AddSeconds(epoch);
    ...
    public static TimeSpan ToTimeSpan(this int epoch) => TimeSpan.FromSeconds(epoch);
    ...
    public static EpochTime ToEpochTime(this int epoch) => new(epoch);
    ...
    public static LongEpochTime ToLongEpochTime(this int epoch) => new(epoch.ToLongEpochTimestamp());
    ...
    public static long ToLongEpochTimestamp(this int epoch) => epoch * 1000L;
}